...
import com.example.helloweb.generator.MyDslGenerator;
import com.example.helloweb.parser.antlr.MyDslAntlrTokenFileProvider;
import com.example.helloweb.parser.antlr.MyDslParser;
import com.example.helloweb.parser.antlr.internal.InternalMyDslLexer;
import com.example.helloweb.scoping.MyDslScopeProvider;
import com.example.helloweb.serializer.MyDslSemanticSequencer;
import com.example.helloweb.serializer.MyDslSyntacticSequencer;
import com.example.helloweb.services.MyDslGrammarAccess;
import com.example.helloweb.validation.MyDslConfigurableIssueCodesProvider;
import com.example.helloweb.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/example/helloweb/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.example.helloweb.MyDsl");
	}
